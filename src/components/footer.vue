<template>
  <v-footer dark padless>
    <v-card flat tile class="teal darken-4 text-center">
      <v-row>
        <v-card-text>
      ...
      <v-row>
        <v-col>
          <v-card-title>Tentang Kami</v-card-title>
        ...
        <v-col>
          ...
          <v-card-text>
            Prenggan, KG II/980, Kotagede, Prenggan, Kec. Kotagede, Kota Yogyakarta, Daerah Istimewa Yogyakarta 55172
          </v-card-text>
        </v-col>
      </v-row>
      ...
      <v-card-text class="white--text">
        {{ new Date().getFullYear() }} — <strong>By IT Center PPP Nurul Ummahat</strong>
      </v-card-text>
    </v-card>
  </v-footer>
</template>
